...
/* package tic-tac-toe-hs-0.1.0.0 */
#ifndef VERSION_tic_tac_toe_hs
#define VERSION_tic_tac_toe_hs "0.1.0.0"
#endif /* VERSION_tic_tac_toe_hs */
#ifndef MIN_VERSION_tic_tac_toe_hs
#define MIN_VERSION_tic_tac_toe_hs(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_tic_tac_toe_hs */
...
#define CURRENT_COMPONENT_ID "tic-tac-toe-hs-0.1.0.0-inplace-tic-tac-toe-hs"
